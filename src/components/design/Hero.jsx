...
export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 h-6 mx-2.5 bg-light-divider shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-8" />
      <div className="relative z-1 h-6 mx-6 bg-light-divider/70 shadow-xl rounded-b-[1.25rem] lg:h-6 lg:mx-20" />
    </>
  );
};
...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[55.25rem] left-10 right-10 h-0.25 bg-light-border pointer-events-none xl:block" />
...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -z-60 -top-[1rem] left-1/2 w-[78rem] aspect-square border border-light-border/50 dark:border-[rgba(255,255,255,0.07)] rounded-full -translate-x-1/2 md:-top-[0.7rem] xl:-top-[1rem]">
      <Rings />
